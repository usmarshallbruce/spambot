...
echo -e "${amarelo}Baixando dependencias (pode demorar)...${tag}"
cd SPAM-BOT
...
echo -e "${amarelo}Finalizando...${tag}"
cd $HOME
...
echo -e "${amarelo}Instalação finalizada, comando principal${tag} ${branco}spam${tag}"
